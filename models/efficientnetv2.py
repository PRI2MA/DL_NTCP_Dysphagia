    ...
    def __init__(self, cfgs, n_features,
        ...
        if (linear_units is None) or (len(linear_units) == 0):
            ...
            for i in range(len(linear_units) - 1):
                ...
                # NEW NEW: ADD THIS TO DCNN_LRELU.PY TOO!
...
# NEW NEW
def get_efficientnetv2(model_name, channels, n_features, num_classes, dropout_p, linear_units, clinical_variables_position, clinical_variables_linear_units, clinical_variables_dropout_p, use_bias, lrelu_alpha):
