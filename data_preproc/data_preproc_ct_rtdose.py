...
def load_ct(path_ct, logger):
    ...
    Args:
        path_ct: folder path containing the CT DICOM files. E.g. path_rtdose = D:/DICOM/0123456/20130221/CT/
        logger:
...
def resample_rtdose_as_ct(image_rtdose, image_ct):
    ...
    resampled_image_rtdose = sitk.Resample(image_rtdose, image_ct, transform=sitk.Transform(),
